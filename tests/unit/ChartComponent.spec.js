...
describe('ChartComponent.vue test', () => {
  ...
  it('Check axios call', async () => {
    ...
    expect(axios.get).toBeCalledWith('https://fcsapi.com/api-v2/forex/history?symbol=PLN/EUR&period=1d&from=2020-01-01T12:00&to=2021-01-01T12:00&access_key=undefined');
  });
