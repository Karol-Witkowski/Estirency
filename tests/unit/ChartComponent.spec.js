...
describe('ChartComponent.vue test', () => {
  ...
  it('Check axios call', async () => {
    ...
    expect(axios.get).toBeCalledWith('https://fcsapi.com/api-v2/forex/history?symbol=PLN/EUR&period=1d&from=2019-12-23T12:00&to=2020-12-23T12:00&access_key=WOR4I12d7qPWzV0A3yw1KRHeApKaB8ZjCtpsy9ZTzCnOeNUu9k');
  });
